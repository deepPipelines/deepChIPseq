...
id: "multiBamSummary_BED_file"
label: "multiBamSummary BED-file"
...
baseCommand: ["multiBamSummary", "BED-file"]
...
inputs:
  ...
  bedfile:
    ...
    inputBinding:
      ...
      prefix: --BED
    doc: |
      Limits the coverage analysis to the regions specified in this file. (default: None)
