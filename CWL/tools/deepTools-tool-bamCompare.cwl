...
doc: |
  ...
  Optional arguments:
    --scaleFactorsMethod {readCount,SES}
      Method to use to scale the samples. Default
      "readCount". (default: readCount)
    -l SAMPLELENGTH
    ...
    --ratio {log2,ratio,subtract,add,reciprocal_ratio}
      ...
      fold changes. *NOTE*: Only with --ratio subtract can
      --normalizeTo1x or --normalizeUsingRPKM be used.
      (default: log2)
    --pseudocount PSEUDOCOUNT
      small number to avoid x/0. Only useful together with
      --ratio log2 or --ratio ratio . (default: 1)
    -bs INT bp
